...
import { productUodateValidationSchema, productValidationSchema } from "./product-validation-schema";
import fs from "fs";
...
const updateProduct = async (id: string, imgLocalUrl: string,
    galleryImgLocalPaths: string[], data: Partial<TProduct>) => {
